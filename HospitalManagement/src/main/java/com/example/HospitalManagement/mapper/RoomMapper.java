...
public interface RoomMapper {
    ...
    @Mapping(target = "patients", ignore = true) // Handle patients list separately if needed
    ...
    default List<Patient> mapPatientIdsToPatients(List<Long> patientIds) {
        // Implement this method according to your data source for fetching patients by ID

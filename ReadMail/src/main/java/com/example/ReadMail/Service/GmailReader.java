...
public class GmailReader {
    ...
    private static final String USERNAME = "lokeshkhadse.eidiko@gmail.com"; // Replace with your Gmail address
    private static final String PASSWORD = "ywic fvhe pxum mjem"; // Replace with your Gmail app password
    private static final String KEYWORD = "Code"; // Replace with the keyword to search in subject
